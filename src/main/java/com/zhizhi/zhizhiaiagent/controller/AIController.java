...
public class AIController {
    ...
    public Flux<ServerSentEvent<Object>> doChatByServerSSE(String message, String chatId) {
        ...
        Flux<ServerSentEvent<Object>> map = stringFlux.map(data -> ServerSentEvent.builder().data(data).build());
        return  map;
    }
    ...
    public SseEmitter doChatBySseEmitter(String message, String chatId) {
        ...
        loveApp.doChatByStream(message, chatId).subscribe(data -> {
            try {
    ...
    public SseEmitter doChatByZhizhiManus(String message) {
        ZhizhiManus zhizhiManus = new ZhizhiManus(toolCallbacks, dashscopeChatModel);
